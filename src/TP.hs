...
correrDurante tiempo unAuto = Auto (color unAuto) (velocidad unAuto) (distancia unAuto + tiempo*(velocidad unAuto)) 

alterarVelocidad::(Int->Int->Int)->Int->Auto->Auto
alterarVelocidad funcion cantidad unAuto = Auto (color unAuto) (funcion (velocidad unAuto) cantidad) (distancia unAuto)
...
jetpack tiempo autoTrigger carrera = afectarALosQueCumplen (==autoTrigger) 
                                    (alterarDistancia (bonusJetpack autoTrigger (2*(velocidad autoTrigger)) tiempo))
                                    (autos carrera)
--extra 3                                 
type Velocidad=Int
type Tiempo = Int
...
alterarDistancia distancia unAuto = Auto (color unAuto) (velocidad unAuto) distancia
---------
{-----------------------------------------------}
